...
import 'package:currency_converter/presentation/components/chart/base/base_chart/render_base_chart.dart';
import 'package:currency_converter/presentation/components/chart/line_chart/line_chart_data.dart';
import 'package:currency_converter/presentation/components/chart/line_chart/line_chart_painter.dart';
...
class RenderLineChart extends RenderBaseChart<LineTouchResponse> {
  ...
  PaintHolder<LineChartData> get paintHolder => PaintHolder(data, targetData, textScaler);
